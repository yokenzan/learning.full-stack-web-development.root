...
import { Alert, AlertColor, Box, Button, Card, Paper, Snackbar, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography } from "@mui/material";
...
export default function Page({ params }: {
    ...
    const handlePurchase = (data: FormData) => {
        result("success", "仕入れました。");
    };

    const handleSell = (data: FormData) => {
        result("success", "卸しました。");
    };
